angular.module("myApp")
	.service("MyApis", ['$timeout', function MyApis($timeout) {
	    ...
	    var getProducts = function getProducts() {
			...
			var getFilteredProducts = function getFilteredProducts(partner) {
				return $timeout(function() {
    			return {
                then: function (callback) {
									  // The idea here is to return the subset of products from the Partner data - need to return objects
                    callback(data.partner[1].products);
                }
            };
	    	}, 0);
			}
